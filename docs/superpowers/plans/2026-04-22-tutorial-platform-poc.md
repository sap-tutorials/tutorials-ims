...
- [x] **Step 1: Create `approuter/package.json`**
...
- [x] **Step 2: Create `approuter/xs-app.json`**
...
- [x] **Step 3: Create `xs-security.json`**
...
- [x] **Step 1: Create `scripts/parsers/types.ts`**
...
- [x] **Step 3: Implement image resolver**
...
- [x] **Step 3: Implement OPTION block converter**
...
- [x] **Step 1: Create the POC tutorial manifest**
...
- [x] **Step 3: Verify generated files**
...
- [x] **Step 1: Create `site/.vitepress/config.ts`**
...
- [x] **Step 2: Create `site/.vitepress/theme/styles/sap-fundamental.css`**
...
- [x] **Step 3: Create `site/.vitepress/theme/index.ts`**
...
- [x] **Step 4: Create stub components to unblock dev server**
...
- [x] **Step 6: Run the dev server and validate CSS integration**
...
- [x] **Step 1: Create `site/.vitepress/theme/composables/useApi.ts`**
...
- [x] **Step 1: Create `site/.vitepress/theme/components/TutorialStep.vue`**
...
- [x] **Step 1: Create `site/.vitepress/theme/components/ProgressBar.vue`**
...
- [x] **Step 1: Create `site/.vitepress/theme/components/PointsBadge.vue`**
...
- [x] **Step 1: Create `site/.vitepress/theme/components/MiniNavigator.vue`**
...
- [x] **Step 1: Create `site/.vitepress/theme/components/StepValidation.vue`**
...
- [x] **Step 1: Rewrite `TutorialLayout.vue`**
...
- [x] **Step 2: Run dev server and verify layout**
...
- [x] **Step 1: Create `site/.vitepress/theme/components/TutorialList.vue`**
...
- [x] **Step 2: Update `site/index.md` to use TutorialList**
...
- [x] **Step 3: Register TutorialList globally**
...
- [x] **Step 4: Run dev server and verify listing page**
...
- [x] **Step 1: Run the full build chain**

```bash
npm run fetch-tutorials && npm run dev
```

- [x] **Step 2: Test the tutorial listing page**

Navigate to `http://localhost:5173/`
Verify:
- [x] Page loads with SAP Fundamental Styles colors
- [x] Search bar filters tutorials by title
- [x] Tutorial cards are grouped by group title
- [x] Clicking a tutorial card navigates to `/tutorials/<slug>`

- [x] **Step 3: Test tutorial page**

Navigate to `http://localhost:5173/tutorials/hana-cloud-cap-create-project`
Verify:
- [x] Header shows: title, description, "beginner" badge, "15 min", "Thomas Jung"
- [x] Breadcrumb shows "Tutorials / Set Up SAP HANA Cloud and CAP Project"
- [x] Previous link goes to `hana-cloud-deploying`
- [x] Next link goes to `hana-cloud-cap-create-database-cds`
- [x] Tutorial content renders as **collapsible step accordions** (TutorialStep components)
- [x] Each step shows: numbered badge, title, expand/collapse toggle
- [x] Each step has a "Done" button at the bottom
- [x] Images resolve to `raw.githubusercontent.com` URLs (visible in img src)
- [x] No JavaScript errors in browser console

- [x] **Step 4: Test OptionTabs (if any POC tutorial has OPTION blocks)**

If a tutorial contains OPTION blocks, verify:
- [x] Tabs render with tab names
- [x] Clicking a tab switches content
- [x] Content renders correctly within each tab

- [x] **Step 5: Test static build**
...
- [x] **Step 6: Commit any fixes from smoke testing**
...
- [x] **Step 3: Verify build output structure**
