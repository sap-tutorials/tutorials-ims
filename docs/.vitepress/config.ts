    ...
    sidebar: {
      ...
      '/developers/': [
        ...
        { text: 'Operations', items: [
          ...
          { text: 'Akamai .well-known forward', link: '/developers/operations/akamai-well-known-forward' },
          ...
          { text: 'Consent CMP rollback',      link: '/developers/operations/consent-cmp-rollback' },
        ...
        { text: 'Reference', collapsed: true, items: [
          ...
          { text: 'Generative UI Research',    link: '/developers/reference/generative-ui-research' },
