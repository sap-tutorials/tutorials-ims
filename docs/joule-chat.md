...
- [build.md](developers/architecture/build.md) — how tutorial content (which the search tool returns) gets into HANA
- [mta-deployment.md](mta-deployment.md) — `tutorials-srv` deploy procedures
