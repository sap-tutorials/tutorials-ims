  ...
  try {
    ...
    sessions = trackIds.length
      ? await SELECT.from(ext.Session)
          .columns('ID', 'SESSIONCODE', 'TRACK_ID', 'TITLE', 'ABSTRACT', 'STATUS', 'SESSIONLENGTH', 'WEEK', 'SCHEDULEDSTART', 'SCHEDULEDTIMEZONE', 'BROADCASTINGPREFERENCE', 'YOUTUBEURL', 'COMMUNITYEVENTURL', 'SURVEYURL', 'ACTIVITY_ID')
