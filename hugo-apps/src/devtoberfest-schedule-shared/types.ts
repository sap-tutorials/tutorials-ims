...
export interface RelatedTechEdSession { slug: string; title: string; sessionCode?: string; venue?: string; url?: string; sharedConceptCount?: number }
export interface Session { id: string; kind: 'session'; title: string; abstract?: string; sessionCode?: string; sessionLength?: string; broadcastingPreference?: 'Live' | 'PreRecorded' | null; trackId?: string; trackName?: string; trackDay?: string; week?: string; scheduledStart?: string; scheduledTimeZone?: string; recordingStart?: string; youtubeUrl?: string; communityEventUrl?: string; activityId?: string | null; status?: string; linkedinUrl?: string; surveyUrl?: string; speakers?: Speaker[]; trackColor?: string; trackEmoji?: string; relatedTechEdSessions?: RelatedTechEdSession[] }
