<!--
  hugo-apps/src/shared/cards/GroupCard.vue
  Group card variant. Shared between the / navigator and /browse/.
  ...
  Differs from TutorialCard: uppercase 'GROUP' label, group type
...
<template>
  ...
  >
    ...
    <div class="nav-card__type nav-card__type--group">{{ TYPE_LABEL }}</div>
