...
**[Joule Studio](https://help.sap.com/docs/joule-studio)** is SAP's low-code authoring
environment for designing custom Joule skills, prompts, and tool integrations. It's the
...
Track the launch on the
[Joule Studio product page](https://help.sap.com/docs/joule-studio) and in
[SAP Developer News](https://youtube.com/@sapdevs).
...
See the [classic Joule Studio docs](https://help.sap.com/docs/joule-studio) for the
current authoring reference.
