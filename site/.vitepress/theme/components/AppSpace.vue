...
/* Step card wrapper — gives each step a Fiori tile feel */
.timeline-content {
  flex: 1;
  min-width: 0;
  background: var(--sapTile_Background, #fff);
...
/* Info-label style type badges (matches fd-info-label pattern) */
.item-type-label {
  font-size: 0.6875rem;
  font-weight: 600;
  letter-spacing: 0.02em;
...
/* ═══════════════════════════════════════════════════════════════════
   ...
   Gradient identity: #5D36FF → #A100C2, linear 180°
   ═══════════════════════════════════════════════════════════════════ */
...
/* Timeline — dark joule in-progress */
...
/* ═══════════════════════════════════════════════════════════════════
   ...
   Core colorway: blue to pink  |  Palette: Blue 4/6/7/10/11
   Blue 4 #89D1FF  Blue 6 #1B90FF  Blue 7 #0070F2
   Blue 10 #002A86  Blue 11 #00144A  Pink accent #C850C0
   ═══════════════════════════════════════════════════════════════════ */
...
/* ═══════════════════════════════════════════════════════════════════
   ...
   Deep navy base with light-blue + pink accents
   ═══════════════════════════════════════════════════════════════════ */
...
/* Blue-to-pink gradient — dark variant */
...
/* Timeline — dark sapphire available */
...
/* Timeline — dark sapphire in-progress */
...
/* Info-label badge — dark sapphire */
