  ...
  return ControllerExtension.extend("sap.tutorials.admin.tutorials.ext.SourceMarkdownHandler", {
    override: {
      onInit: function () {
        ...
        // first paint before the action call resolves.
    ...
    _loadSource: function (sSlug) {
      ...
      // tutorial before the new request resolves.
      oModel.setData({
        markdown: null,
        renderedHtml: "",
        sourceHash: null,
      ...
      fetch("/admin/getTutorialSource", {
        ...
        // Silent on failure — section's "no source captured" IllustratedMessage
        // covers both legacy (sourceContent=null) and failure cases. Log so
