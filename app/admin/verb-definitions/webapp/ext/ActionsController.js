sap.ui.define([
  ...
  // wrong reader: bug #TBD — "Mark selected as reviewed" toast-showed
  // "Select one or more rows first" and the POST never left the browser, so
  // AI_SEEDED rows never flipped. Verified against DEV UI5 1.136 that only
