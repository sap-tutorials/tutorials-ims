...
describe('IRI prefix lockstep', () => {
  // 16 known entity types (7 Phase 1-3 types + 8 external-content types from
  // Phases 4.1-4.8 + devtoberfest-session from #2311).
  const expectedTypes = [
  ...
  it('every prefix in KG_IRI_PREFIXES has a corresponding helper export', () => {
    // Sanity: the registry covers exactly the 16 known entity types
