...
describe('IRI prefix lockstep', () => {
  // 19 known entity types (7 Phase 1-3 types + 8 external-content types from
  // Phases 4.1-4.8 + devtoberfest-session from #2311 + teched-session/speaker/
  // track from #2312).
  const expectedTypes = [
    ...
    'community-event', 'devtoberfest-session',
    'teched-session', 'teched-speaker', 'teched-track',
  ];

  it('every prefix in KG_IRI_PREFIXES has a corresponding helper export', () => {
    // Sanity: the registry covers exactly the 19 known entity types
    ...
    // Phase 4.7 + community-event from Phase 4.8 + devtoberfest-session from
    // #2311 + teched-session/speaker/track from #2312).
