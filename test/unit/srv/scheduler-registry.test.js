...
describe('scheduler — JOB_REGISTRY chassis', () => {
  ...
  it('registerJobs() registers exactly 48 jobs (lockstep)', async () => {
    ...
    expect(names).toContain('top-tutorials');
