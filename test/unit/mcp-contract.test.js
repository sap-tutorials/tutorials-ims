...
const CURATED_TOOLS = {
  SearchService: ['search_tutorials', 'list_missions', 'get_mission', 'get_tutorial', 'search_events', 'search_teched', 'search_channels'],
...
const EXPECTED_PARAMS = {
  ...
  search_teched:         ['query', 'venue', 'track', 'limit'],
  search_channels:       ['query', 'category', 'platform', 'ownerScope', 'limit'],
...
const PHASE2_ANONYMOUS_TOOLS = [
  ...
  { service: 'SearchService', name: 'semantic_search', params: ['query', 'corpus', 'topK', 'minScore'] },
];
